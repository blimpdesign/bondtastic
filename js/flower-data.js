...
var property_display_names = ["Films", "Kills", "Girls kissed", "Girls bedded", "Times believed dead", "'Bond. James. Bond.' used", "Martinis Drunk", "Audience rating (%)", "Critics (RT) Rating (%)", "Profitability (x Budget)"];
