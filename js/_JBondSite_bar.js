$(document).ready(function () {
  ...
  //  $('#dataGrid div:nth-child(6n+1)').css('margin-left', '0');

    //on hover change the color as per the id 
  /*  $('#filters > li').hover(
        //handlerIn
        function (event) {
            filter = $(this).attr('id');
            var icon = $(this).find('.svgicon');
            console.log(icon);
    ...
    */
    ...
    $('#filters > li').on('click', function (event) {
        ...
        $('#dataGrid').html(''); //set previous data blank
           ...
           // debugger;
            switch (filter) {
                ...
                case 'films':
                    ...
                    $('#dataStatement').html('Click on bar to see the luckiest one..');
                ...
                case 'kills':
                    ...
                    $('#dataStatement').html('Click on bar to see the destructive one..');
                ...
                case 'kissed':
                    ...
                    $('#dataStatement').html('Click on bar to see the Man..');
